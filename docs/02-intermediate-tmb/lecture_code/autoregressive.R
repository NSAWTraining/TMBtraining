...
###################
TMB::compile( "docs/02-intermediate-tmb/lecture_code/autoregressive.cpp" )
dyn.load( TMB::dynlib("docs/02-intermediate-tmb/lecture_code/autoregressive") )
...
load("docs/02-intermediate-tmb/lecture_code/bnmk_n100.Rdata")
bnmk_n100[order(bnmk_n100$elapsed),]
